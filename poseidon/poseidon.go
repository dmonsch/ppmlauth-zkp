// Package poseidon contains helpers to build Poseidon hash constructions
// for use inside gnark circuits. Functions here are written to operate
// over the gnark frontend.API so they can be used directly when
// constructing constraints for zero-knowledge circuits.
//
// Attribution: The Poseidon permutation / hash function used here follows
// the design and parameters described by Grassi et al., USENIX Security
// 2021. See: https://www.usenix.org/conference/usenixsecurity21/presentation/grassi
package poseidon
